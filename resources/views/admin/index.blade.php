...
@endphp
	...
	{!! Form::open(['action' => 'docs@store', 'class'=>'form']) !!}			
			...
			{!! Form::select('location',['AGBARA'=>'AGBARA', 'IKOYI'=>'IKOYI'],null, array('class' => 'input-md emailinput form-control', 'id'=>'location', 'placeholder'=>'AGBARA/IKOYI')); !!}
                            ...
                            <td >	
			{!! Form::select('company',array('ESRNL'=>'ESRNL', 'NPRNL'=>'NPRNL', 'PFNL'=>'PFNL','IKOYI'=>'IKOYI'),null, array('class' => 'input-md emailinput form-control', 'id'=>'company', 'placeholder'=>'e.g Ikoyi office')); !!}							
						</td>
                            <td><input class="form-control" id="to"   type="email"></td>
						...
						{!! Form::submit('Add Recipient', array('class' => 'btn btn-default pull-right','id'=>'saveRecipient','style'=> 'margin-top:50px')) !!}	
            </div>
              </div>
